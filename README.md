...
pyinstaller --noconfirm --onedir --windowed --add-data "caminho_do_seu_python/site-packages/customtkinter:customtkinter/" --add-data "JetBrainsMonoNerdFont-Regular.ttf:." --hidden-import PIL._tkinter_finder app.py
